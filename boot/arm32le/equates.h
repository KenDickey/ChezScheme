...
#define tc_alloc_counter_disp 0x150
...
#define tc_compress_format_disp 0x13C
#define tc_compress_level_disp 0x140
...
#define tc_instr_counter_disp 0x148
#define tc_keyboard_interrupt_pending_disp 0xD8
#define tc_lz4_out_buffer_disp 0x144
...
#define tc_parameters_disp 0x158
...
#define ALLOCCOUNTER(x) (*((U64 *)((uptr)(x)+336)))
...
#define COMPRESSFORMAT(x) (*((ptr *)((uptr)(x)+316)))
#define COMPRESSLEVEL(x) (*((ptr *)((uptr)(x)+320)))
...
#define INSTRCOUNTER(x) (*((U64 *)((uptr)(x)+328)))
#define KEYBOARDINTERRUPTPENDING(x) (*((ptr *)((uptr)(x)+216)))
#define LZ4OUTBUFFER(x) (*((void* *)((uptr)(x)+324)))
...
#define PARAMETERS(x) (*((ptr *)((uptr)(x)+344)))
